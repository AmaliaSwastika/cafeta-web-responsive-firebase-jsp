...
<body class="col-12" style="background-color: #F3DEBA;">  
  ...
  <div class="container" style="margin-top: 170px;">
    <div class="row justify-content-center">
      <div class="col-md-6">
        <h2 class="text-center font-weight-bold">CAFETA LOGIN</h2>
      </div>
    </div>
    ...
    <div class="row justify-content-center">
      <div class="col-md-6">
        ...
        <form id="loginForm">
            ...
            <button type="submit" class="btn btn-primary" style="background-color: #675D50;" >Login</button>
            
            <div>
              <span>Don't have an account?
               <label><a href="register.jsp" style="color: black;">Register</a></label>
              </span>
            </div>
          </form>
        </div>
  ...
  <!--FOOTER-->
  <div class="row">
    <footer class="footer" style="width: 100%; margin-top: 110px;">
      <div class="container">
          <div class="row">
